        ...
        <table class="doc-table">
            <thead>
                <tr>
                    ...
                    <th class="text-right" style="width:22%">Amount (<?php echo e($proFormaInvoice->currency?->code ?? 'KSH'); ?>)</th>
                </tr>
            </thead>
            <tbody>
                ...
                ?>
                <tr>
                    <td class="text-right" style="color:#888;font-size:12px"><?php echo e($loop->iteration); ?></td>
                    <td>
